<template>
  <div>
    <el-button @click="$router.push({ name: 'NewuseruserList' })">新增</el-button>
    <el-table
    ...
    >
      ...
      <el-table-column label="用户昵称" prop="nickName" width="260"></el-table-column>
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          <el-button size="small" @click="editXIUGAI(scope.row)">修改</el-button>
